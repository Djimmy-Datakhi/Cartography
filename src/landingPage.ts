...
private page: HTMLElement
    ...
    constructor(){
        ...
        comDiv.setAttribute("class","communication");
        let text = document.createElement("span");
        text.setAttribute("class","powered");
        ...
        "Si vous n'avez pas la hierarchie complète, utiliser les fonction de formatage pour spécifier votre hierarchie";
